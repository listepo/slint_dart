...
@ffi.DefaultAsset('package:slint_native/src/bindings.g.dart')
library;
...
@ffi.Native<ffi.Void Function(SlintNativeDefinitionList )>()
external void slint_native_definitions_free(SlintNativeDefinitionList list,
);
...
@ffi.Native<SlintNativeDefinitionList Function(SlintNativeEngine , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>()
external SlintNativeDefinitionList slint_native_engine_compile(SlintNativeEngine engine,
ffi.Pointer<ffi.Char> source,
ffi.Pointer<ffi.Char> path,
);

@ffi.Native<ffi.Void Function(SlintNativeEngine )>()
external void slint_native_engine_free(SlintNativeEngine engine,
);

@ffi.Native<SlintNativeEngine Function()>()
external SlintNativeEngine slint_native_engine_new();

@ffi.Native<ffi.Void Function(SlintNativeInstance )>()
external void slint_native_instance_free(SlintNativeInstance instance,
);

@ffi.Native<ffi.Pointer<ffi.Char> Function(SlintNativeInstance , ffi.Pointer<ffi.Char> )>()
external ffi.Pointer<ffi.Char> slint_native_instance_get_property(SlintNativeInstance instance,
ffi.Pointer<ffi.Char> name,
);

@ffi.Native<ffi.Pointer<ffi.Char> Function(SlintNativeInstance , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>()
external ffi.Pointer<ffi.Char> slint_native_instance_invoke(SlintNativeInstance instance,
ffi.Pointer<ffi.Char> name,
ffi.Pointer<ffi.Char> args_json,
);

@ffi.Native<ffi.Void Function(SlintNativeInstance , ffi.Pointer<ffi.Char> , ffi.Bool )>()
external void slint_native_instance_key_event(SlintNativeInstance instance,
ffi.Pointer<ffi.Char> text,
bool pressed,
);

@ffi.Native<ffi.Void Function(SlintNativeInstance , ffi.Uint8 , ffi.Float , ffi.Float , ffi.Uint8 , ffi.Float , ffi.Float )>()
external void slint_native_instance_pointer_event(SlintNativeInstance instance,
int kind,
double x,
double y,
int button,
...
@ffi.Native<ffi.Bool Function(SlintNativeInstance , ffi.Pointer<ffi.Uint8> , ffi.UintPtr )>()
external bool slint_native_instance_render(SlintNativeInstance instance,
ffi.Pointer<ffi.Uint8> buffer,
int len,
);

@ffi.Native<ffi.Bool Function(SlintNativeInstance , ffi.Pointer<ffi.Char> , SlintNativeCallbackFn , ffi.Pointer<ffi.Void> )>()
external bool slint_native_instance_set_callback(SlintNativeInstance instance,
ffi.Pointer<ffi.Char> name,
SlintNativeCallbackFn cb,
ffi.Pointer<ffi.Void> user_data,
);

@ffi.Native<ffi.Bool Function(SlintNativeInstance , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>()
external bool slint_native_instance_set_property(SlintNativeInstance instance,
ffi.Pointer<ffi.Char> name,
ffi.Pointer<ffi.Char> json,
);

@ffi.Native<ffi.Void Function(SlintNativeInstance , ffi.Uint32 , ffi.Uint32 )>()
external void slint_native_instance_set_size(SlintNativeInstance instance,
int width,
int height,
);

@ffi.Native<SlintNativeInstance Function(SlintNativeDefinitionList , ffi.Uint32 )>()
external SlintNativeInstance slint_native_instantiate(SlintNativeDefinitionList list,
int index,
);

@ffi.Native<ffi.Pointer<ffi.Char> Function()>()
external ffi.Pointer<ffi.Char> slint_native_last_error();

@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Char> )>()
external void slint_native_string_free(ffi.Pointer<ffi.Char> s,
);
