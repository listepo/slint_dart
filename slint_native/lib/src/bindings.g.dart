...
/// Generated FFI bindings for slint-native-ffi. Do not edit.
class SlintNativeBindings{
/// Holds the symbol lookup function.
final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) _lookup;

/// The symbols are looked up in [dynamicLibrary].
SlintNativeBindings(ffi.DynamicLibrary dynamicLibrary): _lookup = dynamicLibrary.lookup;

/// The symbols are looked up with [lookup].
SlintNativeBindings.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup): _lookup = lookup;
...
int slint_native_definitions_count(SlintNativeDefinitionList list,
) {
  
  return _slint_native_definitions_count(list,
);
}

late final _slint_native_definitions_countPtr = _lookup<
    ffi.NativeFunction<ffi.Uint32 Function(SlintNativeDefinitionList )>>('slint_native_definitions_count');
late final _slint_native_definitions_count = _slint_native_definitions_countPtr.asFunction<int Function(SlintNativeDefinitionList )>();

void slint_native_definitions_free(SlintNativeDefinitionList list,
) {
  
  return _slint_native_definitions_free(list,
);
}

late final _slint_native_definitions_freePtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(SlintNativeDefinitionList )>>('slint_native_definitions_free');
late final _slint_native_definitions_free = _slint_native_definitions_freePtr.asFunction<void Function(SlintNativeDefinitionList )>();

ffi.Pointer<ffi.Char> slint_native_definitions_name(SlintNativeDefinitionList list,
int index,
) {
  
  return _slint_native_definitions_name(list,
index,
);
}

late final _slint_native_definitions_namePtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(SlintNativeDefinitionList , ffi.Uint32 )>>('slint_native_definitions_name');
late final _slint_native_definitions_name = _slint_native_definitions_namePtr.asFunction<ffi.Pointer<ffi.Char> Function(SlintNativeDefinitionList , int )>();
...
ffi.Pointer<ffi.Char> path,
  ...
  return _slint_native_engine_compile(engine,
source,
path,
);
}

late final _slint_native_engine_compilePtr = _lookup<
    ffi.NativeFunction<SlintNativeDefinitionList Function(SlintNativeEngine , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('slint_native_engine_compile');
late final _slint_native_engine_compile = _slint_native_engine_compilePtr.asFunction<SlintNativeDefinitionList Function(SlintNativeEngine , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();

void slint_native_engine_free(SlintNativeEngine engine,
) {
  
  return _slint_native_engine_free(engine,
);
}

late final _slint_native_engine_freePtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(SlintNativeEngine )>>('slint_native_engine_free');
late final _slint_native_engine_free = _slint_native_engine_freePtr.asFunction<void Function(SlintNativeEngine )>();

SlintNativeEngine slint_native_engine_new() {
  
  return _slint_native_engine_new();
}

late final _slint_native_engine_newPtr = _lookup<
    ffi.NativeFunction<SlintNativeEngine Function()>>('slint_native_engine_new');
late final _slint_native_engine_new = _slint_native_engine_newPtr.asFunction<SlintNativeEngine Function()>();

void slint_native_instance_free(SlintNativeInstance instance,
) {
  
  return _slint_native_instance_free(instance,
);
}

late final _slint_native_instance_freePtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(SlintNativeInstance )>>('slint_native_instance_free');
late final _slint_native_instance_free = _slint_native_instance_freePtr.asFunction<void Function(SlintNativeInstance )>();

ffi.Pointer<ffi.Char> slint_native_instance_get_property(SlintNativeInstance instance,
ffi.Pointer<ffi.Char> name,
) {
  
  return _slint_native_instance_get_property(instance,
name,
);
}

late final _slint_native_instance_get_propertyPtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(SlintNativeInstance , ffi.Pointer<ffi.Char> )>>('slint_native_instance_get_property');
late final _slint_native_instance_get_property = _slint_native_instance_get_propertyPtr.asFunction<ffi.Pointer<ffi.Char> Function(SlintNativeInstance , ffi.Pointer<ffi.Char> )>();

ffi.Pointer<ffi.Char> slint_native_instance_invoke(SlintNativeInstance instance,
ffi.Pointer<ffi.Char> name,
ffi.Pointer<ffi.Char> args_json,
) {
  
  return _slint_native_instance_invoke(instance,
name,
args_json,
);
}

late final _slint_native_instance_invokePtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(SlintNativeInstance , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('slint_native_instance_invoke');
late final _slint_native_instance_invoke = _slint_native_instance_invokePtr.asFunction<ffi.Pointer<ffi.Char> Function(SlintNativeInstance , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();

void slint_native_instance_key_event(SlintNativeInstance instance,
ffi.Pointer<ffi.Char> text,
bool pressed,
) {
  
  return _slint_native_instance_key_event(instance,
text,
pressed,
);
}

late final _slint_native_instance_key_eventPtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(SlintNativeInstance , ffi.Pointer<ffi.Char> , ffi.Bool )>>('slint_native_instance_key_event');
late final _slint_native_instance_key_event = _slint_native_instance_key_eventPtr.asFunction<void Function(SlintNativeInstance , ffi.Pointer<ffi.Char> , bool )>();
...
double dy,
  ...
  return _slint_native_instance_pointer_event(instance,
kind,
x,
y,
button,
...
late final _slint_native_instance_pointer_eventPtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(SlintNativeInstance , ffi.Uint8 , ffi.Float , ffi.Float , ffi.Uint8 , ffi.Float , ffi.Float )>>('slint_native_instance_pointer_event');
late final _slint_native_instance_pointer_event = _slint_native_instance_pointer_eventPtr.asFunction<void Function(SlintNativeInstance , int , double , double , int , double , double )>();

bool slint_native_instance_render(SlintNativeInstance instance,
ffi.Pointer<ffi.Uint8> buffer,
int len,
) {
  
  return _slint_native_instance_render(instance,
buffer,
len,
);
}

late final _slint_native_instance_renderPtr = _lookup<
...
ffi.Pointer<ffi.Char> json,
  ...
  return _slint_native_instance_set_property(instance,
name,
json,
);
}

late final _slint_native_instance_set_propertyPtr = _lookup<
    ffi.NativeFunction<ffi.Bool Function(SlintNativeInstance , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('slint_native_instance_set_property');
late final _slint_native_instance_set_property = _slint_native_instance_set_propertyPtr.asFunction<bool Function(SlintNativeInstance , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();

void slint_native_instance_set_size(SlintNativeInstance instance,
int width,
int height,
) {
  
  return _slint_native_instance_set_size(instance,
width,
height,
);
}

late final _slint_native_instance_set_sizePtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(SlintNativeInstance , ffi.Uint32 , ffi.Uint32 )>>('slint_native_instance_set_size');
late final _slint_native_instance_set_size = _slint_native_instance_set_sizePtr.asFunction<void Function(SlintNativeInstance , int , int )>();

SlintNativeInstance slint_native_instantiate(SlintNativeDefinitionList list,
int index,
) {
  
  return _slint_native_instantiate(list,
index,
);
}

late final _slint_native_instantiatePtr = _lookup<
    ffi.NativeFunction<SlintNativeInstance Function(SlintNativeDefinitionList , ffi.Uint32 )>>('slint_native_instantiate');
late final _slint_native_instantiate = _slint_native_instantiatePtr.asFunction<SlintNativeInstance Function(SlintNativeDefinitionList , int )>();

ffi.Pointer<ffi.Char> slint_native_last_error() {
  
  return _slint_native_last_error();
}

late final _slint_native_last_errorPtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>('slint_native_last_error');
late final _slint_native_last_error = _slint_native_last_errorPtr.asFunction<ffi.Pointer<ffi.Char> Function()>();

void slint_native_string_free(ffi.Pointer<ffi.Char> s,
) {
  
  return _slint_native_string_free(s,
);
}

late final _slint_native_string_freePtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> )>>('slint_native_string_free');
late final _slint_native_string_free = _slint_native_string_freePtr.asFunction<void Function(ffi.Pointer<ffi.Char> )>();
