...
class SlintSkiaBindings{
/// Holds the symbol lookup function.
final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) _lookup;

/// The symbols are looked up in [dynamicLibrary].
SlintSkiaBindings(ffi.DynamicLibrary dynamicLibrary): _lookup = dynamicLibrary.lookup;

/// The symbols are looked up with [lookup].
SlintSkiaBindings.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup): _lookup = lookup;
...
int slint_skia_definitions_count(ffi.Pointer<ffi.Void> engine,
) {
  
  return _slint_skia_definitions_count(engine,
);
}

late final _slint_skia_definitions_countPtr = _lookup<
    ffi.NativeFunction<ffi.UintPtr Function(ffi.Pointer<ffi.Void> )>>('slint_skia_definitions_count');
late final _slint_skia_definitions_count = _slint_skia_definitions_countPtr.asFunction<int Function(ffi.Pointer<ffi.Void> )>();

void slint_skia_definitions_free(ffi.Pointer<ffi.Void> _definitions,
) {
  
  return _slint_skia_definitions_free(_definitions,
);
}

late final _slint_skia_definitions_freePtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>>('slint_skia_definitions_free');
late final _slint_skia_definitions_free = _slint_skia_definitions_freePtr.asFunction<void Function(ffi.Pointer<ffi.Void> )>();

ffi.Pointer<ffi.Char> slint_skia_definitions_name(ffi.Pointer<ffi.Void> _engine,
int _index,
) {
  
  return _slint_skia_definitions_name(_engine,
_index,
);
}

late final _slint_skia_definitions_namePtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Void> , ffi.UintPtr )>>('slint_skia_definitions_name');
late final _slint_skia_definitions_name = _slint_skia_definitions_namePtr.asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Void> , int )>();

ffi.Pointer<ffi.Void> slint_skia_engine_compile(ffi.Pointer<ffi.Void> engine,
ffi.Pointer<ffi.Char> source,
ffi.Pointer<ffi.Char> path,
) {
  
  return _slint_skia_engine_compile(engine,
source,
path,
);
}

late final _slint_skia_engine_compilePtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('slint_skia_engine_compile');
late final _slint_skia_engine_compile = _slint_skia_engine_compilePtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();

void slint_skia_engine_free(ffi.Pointer<ffi.Void> engine,
) {
  
  return _slint_skia_engine_free(engine,
);
}

late final _slint_skia_engine_freePtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>>('slint_skia_engine_free');
late final _slint_skia_engine_free = _slint_skia_engine_freePtr.asFunction<void Function(ffi.Pointer<ffi.Void> )>();

ffi.Pointer<ffi.Void> slint_skia_engine_new() {
  
  return _slint_skia_engine_new();
}

late final _slint_skia_engine_newPtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Void> Function()>>('slint_skia_engine_new');
late final _slint_skia_engine_new = _slint_skia_engine_newPtr.asFunction<ffi.Pointer<ffi.Void> Function()>();

void slint_skia_instance_free(ffi.Pointer<ffi.Void> instance,
) {
  
  return _slint_skia_instance_free(instance,
);
}

late final _slint_skia_instance_freePtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>>('slint_skia_instance_free');
late final _slint_skia_instance_free = _slint_skia_instance_freePtr.asFunction<void Function(ffi.Pointer<ffi.Void> )>();

ffi.Pointer<ffi.Char> slint_skia_instance_get_property(ffi.Pointer<ffi.Void> instance,
ffi.Pointer<ffi.Char> name,
) {
  
  return _slint_skia_instance_get_property(instance,
name,
);
}

late final _slint_skia_instance_get_propertyPtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Char> )>>('slint_skia_instance_get_property');
late final _slint_skia_instance_get_property = _slint_skia_instance_get_propertyPtr.asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Char> )>();

ffi.Pointer<ffi.Char> slint_skia_instance_invoke(ffi.Pointer<ffi.Void> instance,
ffi.Pointer<ffi.Char> name,
ffi.Pointer<ffi.Char> args_json,
) {
  
  return _slint_skia_instance_invoke(instance,
name,
args_json,
);
}

late final _slint_skia_instance_invokePtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('slint_skia_instance_invoke');
late final _slint_skia_instance_invoke = _slint_skia_instance_invokePtr.asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();

bool slint_skia_instance_key_event(ffi.Pointer<ffi.Void> instance,
ffi.Pointer<ffi.Char> text,
bool pressed,
) {
  
  return _slint_skia_instance_key_event(instance,
text,
pressed,
);
}

late final _slint_skia_instance_key_eventPtr = _lookup<
    ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Char> , ffi.Bool )>>('slint_skia_instance_key_event');
late final _slint_skia_instance_key_event = _slint_skia_instance_key_eventPtr.asFunction<bool Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Char> , bool )>();

bool slint_skia_instance_pointer_event(ffi.Pointer<ffi.Void> instance,
int kind,
double x,
double y,
int button,
...
double dy,
  ...
  return _slint_skia_instance_pointer_event(instance,
kind,
x,
y,
button,
...
late final _slint_skia_instance_pointer_eventPtr = _lookup<
    ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void> , ffi.Uint8 , ffi.Float , ffi.Float , ffi.Uint8 , ffi.Float , ffi.Float )>>('slint_skia_instance_pointer_event');
late final _slint_skia_instance_pointer_event = _slint_skia_instance_pointer_eventPtr.asFunction<bool Function(ffi.Pointer<ffi.Void> , int , double , double , int , double , double )>();

bool slint_skia_instance_render(ffi.Pointer<ffi.Void> instance,
) {
  
  return _slint_skia_instance_render(instance,
);
}

late final _slint_skia_instance_renderPtr = _lookup<
    ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void> )>>('slint_skia_instance_render');
late final _slint_skia_instance_render = _slint_skia_instance_renderPtr.asFunction<bool Function(ffi.Pointer<ffi.Void> )>();

bool slint_skia_instance_set_property(ffi.Pointer<ffi.Void> instance,
ffi.Pointer<ffi.Char> name,
ffi.Pointer<ffi.Char> value_json,
) {
  
  return _slint_skia_instance_set_property(instance,
name,
value_json,
);
}

late final _slint_skia_instance_set_propertyPtr = _lookup<
    ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('slint_skia_instance_set_property');
late final _slint_skia_instance_set_property = _slint_skia_instance_set_propertyPtr.asFunction<bool Function(ffi.Pointer<ffi.Void> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();

bool slint_skia_instance_set_size(ffi.Pointer<ffi.Void> instance,
double width,
double height,
) {
  
  return _slint_skia_instance_set_size(instance,
width,
height,
);
}

late final _slint_skia_instance_set_sizePtr = _lookup<
    ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void> , ffi.Float , ffi.Float )>>('slint_skia_instance_set_size');
late final _slint_skia_instance_set_size = _slint_skia_instance_set_sizePtr.asFunction<bool Function(ffi.Pointer<ffi.Void> , double , double )>();

int slint_skia_instance_texture_id(ffi.Pointer<ffi.Void> instance,
) {
  
  return _slint_skia_instance_texture_id(instance,
);
}

late final _slint_skia_instance_texture_idPtr = _lookup<
    ffi.NativeFunction<ffi.Int64 Function(ffi.Pointer<ffi.Void> )>>('slint_skia_instance_texture_id');
late final _slint_skia_instance_texture_id = _slint_skia_instance_texture_idPtr.asFunction<int Function(ffi.Pointer<ffi.Void> )>();

ffi.Pointer<ffi.Void> slint_skia_instantiate(ffi.Pointer<ffi.Void> definition,
) {
  
  return _slint_skia_instantiate(definition,
);
}

late final _slint_skia_instantiatePtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> )>>('slint_skia_instantiate');
late final _slint_skia_instantiate = _slint_skia_instantiatePtr.asFunction<ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void> )>();

ffi.Pointer<ffi.Char> slint_skia_last_error() {
  
  return _slint_skia_last_error();
}

late final _slint_skia_last_errorPtr = _lookup<
    ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>('slint_skia_last_error');
late final _slint_skia_last_error = _slint_skia_last_errorPtr.asFunction<ffi.Pointer<ffi.Char> Function()>();

void slint_skia_string_free(ffi.Pointer<ffi.Char> s,
) {
  
  return _slint_skia_string_free(s,
);
}

late final _slint_skia_string_freePtr = _lookup<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> )>>('slint_skia_string_free');
late final _slint_skia_string_free = _slint_skia_string_freePtr.asFunction<void Function(ffi.Pointer<ffi.Char> )>();
