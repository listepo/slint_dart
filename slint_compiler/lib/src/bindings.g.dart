...
@ffi.DefaultAsset('package:slint_compiler/src/bindings.g.dart')
library;

import 'dart:ffi' as ffi;
@ffi.Native<ffi.Pointer<ffi.Char> Function()>()
external ffi.Pointer<ffi.Char> slint_compiler_last_error();

@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Char> )>()
external void slint_compiler_string_free(ffi.Pointer<ffi.Char> s,
);

@ffi.Native<ffi.Void Function(slint_compiler_todo_handle )>()
external void slint_compiler_todo_free(slint_compiler_todo_handle handle,
);

@ffi.Native<ffi.Pointer<ffi.Char> Function(slint_compiler_todo_handle )>()
external ffi.Pointer<ffi.Char> slint_compiler_todo_get_model(slint_compiler_todo_handle handle,
);

@ffi.Native<ffi.Bool Function(slint_compiler_todo_handle , ffi.Pointer<ffi.Char> )>()
external bool slint_compiler_todo_invoke_add_todo(slint_compiler_todo_handle handle,
ffi.Pointer<ffi.Char> text,
);

@ffi.Native<ffi.Bool Function(slint_compiler_todo_handle )>()
external bool slint_compiler_todo_invoke_remove_done(slint_compiler_todo_handle handle,
);

@ffi.Native<ffi.Bool Function(slint_compiler_todo_handle , ffi.Int32 , ffi.Bool )>()
external bool slint_compiler_todo_invoke_toggle_todo(slint_compiler_todo_handle handle,
int index,
bool checked,
);

@ffi.Native<ffi.Void Function(slint_compiler_todo_handle , ffi.Pointer<ffi.Char> , ffi.Bool )>()
external void slint_compiler_todo_key_event(slint_compiler_todo_handle handle,
ffi.Pointer<ffi.Char> text,
bool pressed,
);

@ffi.Native<slint_compiler_todo_handle Function()>()
external slint_compiler_todo_handle slint_compiler_todo_new();

@ffi.Native<ffi.Bool Function(slint_compiler_todo_handle , slint_compiler_callback_add_todo , ffi.Pointer<ffi.Void> )>()
external bool slint_compiler_todo_on_add_todo(slint_compiler_todo_handle handle,
slint_compiler_callback_add_todo cb,
ffi.Pointer<ffi.Void> user_data,
);

@ffi.Native<ffi.Bool Function(slint_compiler_todo_handle , slint_compiler_callback_remove_done , ffi.Pointer<ffi.Void> )>()
external bool slint_compiler_todo_on_remove_done(slint_compiler_todo_handle handle,
slint_compiler_callback_remove_done cb,
ffi.Pointer<ffi.Void> user_data,
);

@ffi.Native<ffi.Bool Function(slint_compiler_todo_handle , slint_compiler_callback_toggle_todo , ffi.Pointer<ffi.Void> )>()
external bool slint_compiler_todo_on_toggle_todo(slint_compiler_todo_handle handle,
slint_compiler_callback_toggle_todo cb,
ffi.Pointer<ffi.Void> user_data,
);

@ffi.Native<ffi.Void Function(slint_compiler_todo_handle , ffi.Uint8 , ffi.Float , ffi.Float , ffi.Uint8 , ffi.Float , ffi.Float )>()
external void slint_compiler_todo_pointer_event(slint_compiler_todo_handle handle,
int kind,
double x,
double y,
int button,
...
@ffi.Native<ffi.Bool Function(slint_compiler_todo_handle , ffi.Pointer<ffi.Uint8> , ffi.UintPtr )>()
external bool slint_compiler_todo_render(slint_compiler_todo_handle handle,
ffi.Pointer<ffi.Uint8> buffer,
int len,
);

@ffi.Native<ffi.Bool Function(slint_compiler_todo_handle , ffi.Pointer<ffi.Char> )>()
external bool slint_compiler_todo_set_model(slint_compiler_todo_handle handle,
ffi.Pointer<ffi.Char> json,
);

@ffi.Native<ffi.Void Function(slint_compiler_todo_handle , ffi.Uint32 , ffi.Uint32 )>()
external void slint_compiler_todo_set_size(slint_compiler_todo_handle handle,
int width,
int height,
);
