...
description: "Add Slint to a new Flutter app from pub.dev."
weight: 10
---
...
monorepo. The [todo example]({{< relref "examples/todo" >}}) in this
...
- [Backends]({{< relref "backends" >}}) — how the split is generated, not
  looked up at runtime.
- [Testing]({{< relref "testing" >}}) — headless (`slint_testing`) and live
  (`slint_patrol`) UI tests.
- [todo example]({{< relref "examples/todo" >}}) — registry per component,
  shared UI imports, tree-shaking canary, release size notes.
- [Contributing]({{< relref "contributing" >}}) — if you are hacking the
