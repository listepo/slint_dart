...
@ffi.DefaultAsset('package:slint_testing/src/bindings.g.dart')
library;
...
@ffi.Native<ffi.Bool Function(SlintTestingApp , ffi.UintPtr )>()
external bool slint_testing_app_click(SlintTestingApp app,
int index,
);

@ffi.Native<ffi.Void Function(SlintTestingApp )>()
external void slint_testing_app_free(SlintTestingApp app,
);

/// Property read; returns JSON. Caller frees with [slint_testing_string_free].
@ffi.Native<ffi.Pointer<ffi.Char> Function(SlintTestingApp , ffi.Pointer<ffi.Char> )>()
external ffi.Pointer<ffi.Char> slint_testing_app_get_property(SlintTestingApp app,
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(SlintTestingApp , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>()
external ffi.Pointer<ffi.Char> slint_testing_app_invoke(SlintTestingApp app,
ffi.Pointer<ffi.Char> name,
...
@ffi.Native<SlintTestingApp Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>()
external SlintTestingApp slint_testing_app_new(ffi.Pointer<ffi.Char> source,
...
@ffi.Native<ffi.Pointer<ffi.Char> Function(SlintTestingApp , ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>()
external ffi.Pointer<ffi.Char> slint_testing_app_query(SlintTestingApp app,
...
external bool slint_testing_app_set_property(SlintTestingApp app,
ffi.Pointer<ffi.Char> name,
...
@ffi.Native<ffi.Bool Function(SlintTestingApp , ffi.UintPtr , ffi.Pointer<ffi.Char> )>()
external bool slint_testing_app_set_value(SlintTestingApp app,
int index,
...
external void slint_testing_elapse_ms(int millis,
);

/// Last error, or null. Caller frees with [slint_testing_string_free].
@ffi.Native<ffi.Pointer<ffi.Char> Function()>()
external ffi.Pointer<ffi.Char> slint_testing_last_error();

@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Char> )>()
external void slint_testing_string_free(ffi.Pointer<ffi.Char> s,
);
