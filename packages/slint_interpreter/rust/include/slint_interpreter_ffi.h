...
/* GENERATED by cbindgen from src/lib.rs, do not edit. Regenerate: cd packages/slint_interpreter/rust && cbindgen --output include/slint_interpreter_ffi.h */
 ...
 */
void slint_interpreter_callback_set_result(const char *json);
